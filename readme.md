...
- Pillars: width 90, scroll speed eases from 184 to 252 as difficulty rises, gaps contract from 218px toward a 140px floor, spacing starts at 260-340px (tightens late run) and clamps to a minimum horizontal separation so pillars never overlap even at peak speed.
...
- Consecutive pillar pairs enforce the guaranteed horizontal spacing budget even under weather or power-up speed boosts.
